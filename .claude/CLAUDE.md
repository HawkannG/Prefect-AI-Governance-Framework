# CLAUDE.md — Claude Warden Framework

## Project Identity
- **What:** AI governance framework for Claude Code - self-protecting hooks and drift tracking
- **Phase:** v1.0
- **Stack:** Bash scripts, Markdown governance files, Claude Code hooks system
